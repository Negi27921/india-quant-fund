        ...
        <>
          ...
          >
            <div style={{
              ...
              border: `1px solid ${isLive ? "rgba(39,174,96,0.25)" : "rgba(106,98,86,0.25)"}`,
              borderRadius: 12,
              boxShadow: isLive
                ? "0 0 60px rgba(39,174,96,0.1), 0 24px 80px rgba(0,0,0,0.2)"
                : "0 0 60px rgba(106,98,86,0.1), 0 24px 80px rgba(0,0,0,0.2)",
              overflow: "hidden",
            }}>
              {/* Header */}
              <div style={{
                ...
                <span style={{
                  ...
                  color: isLive ? "#27AE60" : "var(--accent)",
                ...
                <div>
                      ...
                      {showSug && suggestions.length > 0 && (
                        <motion.div
                          ...
                          style={{
                            ...
                            background: "var(--surface)", border: "1px solid rgba(106,98,86,0.2)",
                        ...
                        >
                          {suggestions.map(s => (
                            <button
                              ...
                              onMouseEnter={e => (e.currentTarget.style.background = "rgba(106,98,86,0.07)")}
                              onMouseLeave={e => (e.currentTarget.style.background = "transparent")}
                              onMouseDown={ev => { ev.preventDefault(); selectStock(s); }}
                            >
                              <span style={{ fontFamily: "var(--font-mono)", fontWeight: 700, fontSize: 11, color: "var(--accent)", minWidth: 90 }}>{s.symbol}</span>
                              <span style={{ fontSize: 11, color: "var(--text-3)", flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{s.name}</span>
                              <span style={{ fontSize: 9, color: "var(--text-3)", background: "rgba(106,98,86,0.6)", border: "1px solid var(--border)", borderRadius: 10, padding: "1px 7px", whiteSpace: "nowrap" }}>{s.sector}</span>
                            </button>
                          ))}
                        </motion.div>
                      )}
                  ...
                  {selectedStock && (
                    <div style={{ marginTop: 6, display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      <span style={{ fontSize: 9, background: "rgba(106,98,86,0.08)", border: "1px solid rgba(106,98,86,0.15)", borderRadius: 10, padding: "1px 7px", color: "var(--accent)" }}>{selectedStock.sector}</span>
                    </div>
                  )}
                </div>
                ...
                {totalCost && (
                  <motion.div
                    ...
                    style={{
                      ...
                      background: "rgba(50,121,249,0.05)", border: "1px solid rgba(106,98,86,0.15)",
                    }}
                  >
                    ...
                    <span style={{ fontFamily: "var(--font-mono)", fontWeight: 700, fontSize: 14, color: "var(--accent)" }}>₹{totalCost}</span>
                  </motion.div>
                )}
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: isLive
                        ...
                        : "linear-gradient(135deg, rgba(106,98,86,0.2), rgba(50,121,249,0.05))",
                      border: isLive ? "1px solid rgba(39,174,96,0.4)" : "1px solid rgba(106,98,86,0.4)",
                      color: isLive ? "#27AE60" : "var(--accent)",
